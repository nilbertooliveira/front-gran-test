  ...
  <div id="createCategoryModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <!-- Modal body -->
        <form id="formCategory" class="p-4 md:p-5" @submit.prevent="handleSubmit">
...
export default defineComponent({
  name: "CreateModalCategory",
  setup() {
    const categoryService = inject('ICategoryService') as ICategoryService;
  ...
  methods: {
    async handleSubmit() {
      try {
        const response = await this.categoryService.store(this.form);
